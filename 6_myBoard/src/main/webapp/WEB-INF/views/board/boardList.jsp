...
<div class="table-responsive">
	...
	<!-- boardList?searchItem=title -->
		<form action ="boardList" method = "get">
			<select name ="searchItem" style ="height: 27px;">
...
<div class="text-center">
      <ul class="pagination">
		<li><a href ="boardList?currentPage=${navi.currentPage - navi.pagePerGroup}&searchItem=${searchItem}&searchWord=${searchWord}">◀◀</a></li> <!-- 앞 그룹 요청 -->
		<li><a href ="boardList?currentPage=${navi.currentPage - 1}&searchItem=${searchItem}&searchWord=${searchWord}">◀</a></li> <!-- 앞 페이지 요청 -->
      	...
      	<li><a href ="boardList?currentPage=${navi.currentPage + 1}&searchItem=${searchItem}&searchWord=${searchWord}">▶</a></li> <!-- 뒤 페이지 요청 -->
      	<li><a href ="boardList?currentPage=${navi.currentPage + navi.pagePerGroup}&searchItem=${searchItem}&searchWord=${searchWord}">▶▶</a></li> <!-- 뒤 그룹 요청 -->
      </ul>
   </div>
